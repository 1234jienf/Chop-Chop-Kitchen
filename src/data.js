...
export const RECIPE_CATALOG = [
  ...
  },
  {
    ...
    steps: [
      ...
      step('roasting', ['chicken'], { title: '치킨 오븐구이', targetPattern: '후우~', hint: '마이크 켜고 「후우~」로 화력을 맞추세요' }),
  ...
  },
  {
    ...
    steps: [
      ...
      step('roasting', ['pastry'], { title: '페이스트리 굽기', targetPattern: '후우~', hint: '마이크 켜고 「후우~」로 화력을 맞추세요' }),
  ...
  },
  {
    ...
    steps: [
      ...
      step('roasting', ['pastry'], { title: '오븐에서 굽기', targetPattern: '후우~', hint: '마이크 켜고 「후우~」로 화력을 맞추세요' }),
  ...
  },
  {
    ...
    steps: [
      ...
      step('roasting', ['chocolate'], { title: '라바 케이크 오븐 굽기', targetPattern: '후우~', hint: '마이크 켜고 「후우~」로 화력을 맞추세요' }),
