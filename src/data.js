...
export const ACTION_STATION = {
  ...
  boiling: 'boil',
  roasting: 'grill',
  putting: 'sprinklePour',
  mixing: 'mix',
  sprinkling: 'sprinklePour',
};
...
export const RECIPE_CATALOG = [
  {
    ...
    steps: [
      ...
      step('mixing', ['avocado', 'onion'], { title: '재료 으깨 섞기', targetPattern: '보글보글', hint: '짧은 소리를 불규칙하게 반복하세요.' }),
    ],
  },
  {
    category: 'appetizer',
  ...
  {
    category: 'appetizer', categoryLabel: '에피타이저', name: 'Caprese Salad', nameKo: '카프레제 샐러드', level: 'normal',
    steps: [
  ...
  },
  {
    ...
    steps: [
      ...
      step('roasting', ['tart'], { title: '타르트 반죽 굽기', targetPattern: '스으-', hint: '약한 소리를 일정하게.' }),
      step('boiling', ['apple'], { title: '사과 시럽 끓이기', targetPattern: '보글보글', hint: '짧은 소리를 여러 번.' }),
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      step('mixing', ['flour'], { title: '크럼블 반죽 섞기', targetPattern: '후루룩', hint: '고슬고슬하게 섞으세요.' }),
    ],
  },
  {
